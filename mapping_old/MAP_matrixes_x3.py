...
#%%
e_matrix = np.load('Wall/MATRIX_C_exc_' + n_el + '.npy')
...
#%% total arrays - 15 s
#n_el = '400'
part_matrix_0 = np.load('Sharma/MATRIX_particles_short.npy')
chain_inv_matrix_0 = np.load('Sharma/MATRIX_chains_inv_short.npy')
