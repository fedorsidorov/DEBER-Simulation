...
part_matrix = np.load('Sharma/MATRIX_particles_short.npy')
chain_inv_matrix = np.load('Sharma/MATRIX_chains_inv_short.npy')

#%
s0, s1, s2, s3, s4 = np.shape(e_matrix)

## probabilities
p1 = 0.1 ## ester group detachment with scissions
p2 = 0.5 ## sure lol
p3 = 0.5 ## ester group detachment w/o scissions
